    ...
    <div class="card">
        ...
        <div class ="card-header header-elements-inline s-filter">
            ...
            <div class="col-md-6">
                ...
                <h6 class="card-title"><b>Product  List</b></h6></div>
                ...
                <a href="{{ url('admin/products/create') }}" class="btn btn-primary" > <i class="fas fa-plus mr-1"></i> Add</a>
    ...
    $(document).ready(function() {
        ...
        var dataTable = $('.get_grind_list').DataTable({
            ...
            columns: [
                ...
                return '<img src="' + data + '" alt="Image" height="50px" width="50px">';
                  }},
